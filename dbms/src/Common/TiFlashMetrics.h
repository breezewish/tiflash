...
#define APPLY_FOR_METRICS(M, F)                                                                                                                     \
    ...
    M(tiflash_disaggregated_breakdown_duration_seconds, "", Histogram,                                                                              \
        F(type_establish, {{"type", "establish"}}, ExpBuckets{0.001, 1.5, 20}),                                                                       \
        F(type_build_task, {{"type", "build_task"}}, ExpBuckets{0.001, 1.5, 20}),                                                                     \
        F(type_fetch_page, {{"type", "fetch_page"}}, ExpBuckets{0.001, 1.5, 20}),                                                                     \
        F(type_pop_ready_tasks, {{"type", "pop_ready_tasks"}}, ExpBuckets{0.001, 1.5, 20}),                                                           \
